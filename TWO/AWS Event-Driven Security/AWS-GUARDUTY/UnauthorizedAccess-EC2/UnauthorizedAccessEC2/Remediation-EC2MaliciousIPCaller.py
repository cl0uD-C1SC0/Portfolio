...
# Essa função lambda altera o SECURITY GROUP DA INSTANCIA QUE FOI IDENTIFICADA
# To get instanceID value, in EventBridge the input PATH should be like this: (This is for EC2 Findings)
"""
{
