# Esse código ira ter como parametro do EventBridge e AWS GuardDuty
#   UnauthorizedAccess:IAMUser/InstanceCredentialExfiltration.OutsideAWS
#   O Código cria uma policy e adiciona ela ao IAM Role
#   Negando todas as ações a todos os serviços e ações da AWS
#
